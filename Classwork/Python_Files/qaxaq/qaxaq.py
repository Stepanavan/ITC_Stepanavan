...
class Human():
	def __init__(self,azganun,anun,shenq):
		self.__azganun=azganun
		self.__anun=anun
		self.shenq=shenq
	...
	def tur_mardu_hascen(self):
		return self.shenq.tur_hasce()
...
Mard=Human("Hakobyan","Vagharsh",A)
print Mard.tur_anun()
print Mard.tur_mardu_hascen()
